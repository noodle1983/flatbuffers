      ...
      if (IsVector(type)) {
        ...
        if (is_default_null) {
          ...
          code_ +=
              ...
              inner_type_name + ">{" +
              constant + "}";
          code_ += "    return flat::buffers::GetRoot<flatbuffers::Vector<" + inner_type_name + ">>(buffer.data())";
          code_ += "  }";
        }
        ...
        if (is_default_null) {
          ...
          code_ += "    auto ret = {{FIELD_VALUE}};";
          code_ += "    if (ret == nullptr){";
          code_ += "      return (const flatbuffers::String*)flatbuffers::GetConstEmptyVector<char>();";
          code_ += "    }";
          code_ += "    return ret;";
          code_ += "  }";
        } else {
          ...
          code_ +=
              ...
              constant + "\"";
          code_ += "    return flat::buffers::GetRoot<flatbuffers::String>(buffer.data())";
          code_ += "  }";
        }
